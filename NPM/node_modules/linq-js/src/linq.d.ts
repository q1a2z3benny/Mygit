declare namespace Enumerable {
    ...
    export function permutation<T>(source: T[] | IEnumerable<T>, count: number, repeatable: boolean = false): IEnumerable<IEnumerable<T>>;

    export function combination<T>(source: T[] | IEnumerable<T>, count: number, repeatable: boolean = false): IEnumerable<IEnumerable<T>>;
    ...
    export function combine<T, TKey, TValue>(source: T[] | IEnumerable<T>, parentSelector: (element: T) => TKey = defaultParentSelector, keySelector: (element: T) => TKey = defaultKeySelector, valueSelector: (element: T) => TValue = defaultSelector, comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer): IEnumerable<ICombine<TKey, TValue>>;
    export function combine<T, TKey, TValue>(source: T[] | IEnumerable<T>, parentSelector: string | number | symbol, keySelector: (element: T) => TKey = defaultKeySelector, valueSelector: (element: T) => TValue = defaultSelector, comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer): IEnumerable<ICombine<TKey, TValue>>;
    export function combine<T, TKey, TValue>(source: T[] | IEnumerable<T>, parentSelector: (element: T) => TKey = defaultParentSelector, keySelector: string | number | symbol, valueSelector: (element: T) => TValue = defaultSelector, comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer): IEnumerable<ICombine<TKey, TValue>>;
    export function combine<T, TKey, TValue>(source: T[] | IEnumerable<T>, parentSelector: string | number | symbol, keySelector: string | number | symbol, valueSelector: (element: T) => TValue = defaultSelector, comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer): IEnumerable<ICombine<TKey, TValue>>;
    ...
    export function combine<T, TKey, TValue>(source: T[] | IEnumerable<T>, parentSelector: (element: T) => TKey = defaultParentSelector, keySelector: (element: T) => TKey = defaultKeySelector, valueSelector: (element: T) => TValue = defaultSelector, comparer: string | number | symbol): IEnumerable<ICombine<TKey, TValue>>;
    export function combine<T, TKey, TValue>(source: T[] | IEnumerable<T>, parentSelector: string | number | symbol, keySelector: (element: T) => TKey = defaultKeySelector, valueSelector: (element: T) => TValue = defaultSelector, comparer: string | number | symbol): IEnumerable<ICombine<TKey, TValue>>;
    export function combine<T, TKey, TValue>(source: T[] | IEnumerable<T>, parentSelector: (element: T) => TKey = defaultParentSelector, keySelector: string | number | symbol, valueSelector: (element: T) => TValue = defaultSelector, comparer: string | number | symbol): IEnumerable<ICombine<TKey, TValue>>;
    export function combine<T, TKey, TValue>(source: T[] | IEnumerable<T>, parentSelector: string | number | symbol, keySelector: string | number | symbol, valueSelector: (element: T) => TValue = defaultSelector, comparer: string | number | symbol): IEnumerable<ICombine<TKey, TValue>>;
    ...
    export interface IEnumerable<T> {
        ...
        permutation(count: number, repeatable: boolean = false): IEnumerable<IEnumerable<T>>;

        combination(count: number, repeatable: boolean = false): IEnumerable<IEnumerable<T>>;
        ...
        combine<TKey, TValue>(parentSelector: (element: T) => TKey = defaultParentSelector, keySelector: (element: T) => TKey = defaultKeySelector, valueSelector: (element: T) => TValue = defaultSelector, comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer): IEnumerable<ICombine<TKey, TValue>>;
        combine<TKey, TValue>(parentSelector: string | number | symbol, keySelector: (element: T) => TKey = defaultKeySelector, valueSelector: (element: T) => TValue = defaultSelector, comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer): IEnumerable<ICombine<TKey, TValue>>;
        combine<TKey, TValue>(parentSelector: (element: T) => TKey = defaultParentSelector, keySelector: string | number | symbol, valueSelector: (element: T) => TValue = defaultSelector, comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer): IEnumerable<ICombine<TKey, TValue>>;
        combine<TKey, TValue>(parentSelector: string | number | symbol, keySelector: string | number | symbol, valueSelector: (element: T) => TValue = defaultSelector, comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer): IEnumerable<ICombine<TKey, TValue>>;
        ...
        combine<TKey, TValue>(parentSelector: (element: T) => TKey = defaultParentSelector, keySelector: (element: T) => TKey = defaultKeySelector, valueSelector: (element: T) => TValue = defaultSelector, comparer: string | number | symbol): IEnumerable<ICombine<TKey, TValue>>;
        combine<TKey, TValue>(parentSelector: string | number | symbol, keySelector: (element: T) => TKey = defaultKeySelector, valueSelector: (element: T) => TValue = defaultSelector, comparer: string | number | symbol): IEnumerable<ICombine<TKey, TValue>>;
        combine<TKey, TValue>(parentSelector: (element: T) => TKey = defaultParentSelector, keySelector: string | number | symbol, valueSelector: (element: T) => TValue = defaultSelector, comparer: string | number | symbol): IEnumerable<ICombine<TKey, TValue>>;
        combine<TKey, TValue>(parentSelector: string | number | symbol, keySelector: string | number | symbol, valueSelector: (element: T) => TValue = defaultSelector, comparer: string | number | symbol): IEnumerable<ICombine<TKey, TValue>>;
